...
from checker import checkAccesoyTipo, checkCopiaHTML
from herramienta import getDirectorio, getRutaHerramienta, copiarDatosAntiguos, getFecha, errorLog
...
def ejecutarHerramienta(herramienta_eval,herramienta,pagina_url,pagina_id):
    if herramienta_eval:
