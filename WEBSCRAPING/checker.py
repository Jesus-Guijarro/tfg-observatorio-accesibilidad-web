...
from herramienta import  driverHeadlessBrowser, getDirectorio, getRutaCopiaHTML


#Función para obtener el valor hash de una copia HTML
def getHashArchivo(ruta_archivo):
...
def checkAccesoyTipo(pagina_web):
    try:
...
def checkCopiaHTML(pagina_id):
    ...
    hash_nuevo=getHashArchivo(ruta_archivo_nuevo)
