...
try:
    ...
    ###TECNICAS###
    def datosTecnicas1(tecnicas,reporte):
        for t in tecnicas:
    ...
    ###CRITERIOS###
    def datosCriterios1(criterios,reporte):
        for c in criterios:
            ...
            try:
                ...
                if isinstance(tecnicas, list):
                    datosTecnicas1(tecnicas,reporte)
                else:
                    datosTecnicas2(c,reporte)

            except Exception as e:
                pass

    def datosCriterios2(p,reporte):
        ...
        try:
            ...
            if isinstance(tecnicas, list):
                ...
                datosTecnicas2(tecnicas,reporte)
        except Exception as e:
            pass

    ###PAUTAS###
    def datosPautas1(pautas,reporte):
        for p in pautas:
            ...
            try:
                ...
                if isinstance(criterios, list):
                    datosCriterios1(criterios,reporte)
                else:
                    datosCriterios2(p,reporte)
            except Exception as e:
                pass

    def datosPautas2(l,reporte):
        ...
        try:
            ...
            if isinstance(criterios, list):
                ...
                datosCriterios2(criterios,reporte)
        except Exception as e:
            pass
    ...
    for l in lista_principios:
        ...
        if isinstance(pautas, list):
            datosPautas1(pautas,reporte)
        else:
            datosPautas2(l,reporte)
