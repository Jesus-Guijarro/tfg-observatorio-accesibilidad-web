...
- **AccessMonitor**: Para evaluar el nivel de accesibilidad de las páginas web.
- **AChecker**: Herramienta de validación de accesibilidad para identificar problemas en el contenido web.
- **European Internet Inclusion Initiative Page Checker**: Para comprobar la inclusión y accesibilidad en internet.
- **Observatorio de Accesibilidad Web de la Universidad Politécnica Salesiana de Ecuador**: Evaluación específica de accesibilidad.
- **Vamolà**: Herramienta que proporciona un análisis detallado de la accesibilidad.
- **WAVE**: Proporciona reportes visuales sobre la accesibilidad de las páginas web.

## Archivos para web scraping

En este proyecto se ha realizado web scraping para obtener los datos de evaluación de algunas de las herramientas. Antes de utilizar dichos archivos, consulta las políticas de uso de los sitios web y contacta a los administradores para obtener el permiso necesario.

**Descargo de responsabilidad:** Este repositorio es únicamente con fines educativos y de demostración. El scraping de contenido de los sitios web puede estar en contra de sus Términos de Servicio (TOS). Por favor, consulta los TOS del sitio correspondiente antes de utilizar cualquier archivo obtenido mediante web scraping. Ni yo ni el software seremos responsables de cualquier consecuencia derivada de su uso. No tengo ninguna afiliación con los sitios web mencionados en este proyecto.
